...
import {
  ...
  Cell, Legend, LineChart, Line, ComposedChart, Area, RadarChart,
...
const evalMetricsComparison = [
  { platform: "TTS Arena (HF)", humanPref: true, wer: false, semanticASR: false, ttsQuality: false, prosody: false, agentMetrics: false, latency: false, scenarios: false },
  { platform: "Artificial Analysis", humanPref: true, wer: false, semanticASR: false, ttsQuality: false, prosody: false, agentMetrics: false, latency: true, scenarios: false },
  { platform: "VoiceBench", humanPref: false, wer: true, semanticASR: false, ttsQuality: false, prosody: false, agentMetrics: true, latency: false, scenarios: true },
  { platform: "Voice Arena", humanPref: true, wer: true, semanticASR: true, ttsQuality: true, prosody: true, agentMetrics: true, latency: true, scenarios: true },
];
...
function PipelineStagesChart() {
  const groupColors = { audio: "#6B7280", asr: "#F59E0B", tts: "#3B82F6", latency: "#EF4444" };
  return (
    <div style={{ margin: "32px 0" }}>
      <FigureHeader
        num={5}
...
function Callout({ children, color = "#10B981" }) {
  return (
    <div style={{
