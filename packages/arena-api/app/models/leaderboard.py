...
class LeaderboardSnapshot(Base):
    ...
    avg_cer: Mapped[float | None] = mapped_column(Float, nullable=True)
    avg_ttfb: Mapped[float | None] = mapped_column(Float, nullable=True)
    avg_e2e_latency: Mapped[float | None] = mapped_column(Float, nullable=True)
    avg_utmos: Mapped[float | None] = mapped_column(Float, nullable=True)
    avg_task_success_rate: Mapped[float | None] = mapped_column(Float, nullable=True)
    avg_coherence: Mapped[float | None] = mapped_column(Float, nullable=True)
